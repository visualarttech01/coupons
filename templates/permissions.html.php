											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td class="hidden-480">
                                                            <td><?php if($key->p_add !='1'){echo '<span class="label label-sm label-warning">No';}else{echo '<span class="label label-sm label-success">Yes</span>';};?></td>
                                                        </td>

                                                        <td class="hidden-480">
                                                            <td><?php if($key->p_edit !='1'){echo '<span class="label label-sm label-warning">No';}else{echo '<span class="label label-sm label-success">Yes</span>';};?></td>
                                                        </td>

                                                        <td class="hidden-480">
                                                            <td><?php if($key->p_view !='1'){echo '<span class="label label-sm label-warning">No';}else{echo '<span class="label label-sm label-success">Yes</span>';};?></td>
                                                        </td>

                                                        <td class="hidden-480">
                                                            <td><?php if($key->p_delete !='1'){echo '<span class="label label-sm label-warning">No';}else{echo '<span class="label label-sm label-success">Yes</span>';};?></td>
                                                        </td>
			...
			<script>
					$(".bootbox-confirm").click(function() {
						...
						bootbox.confirm("Are you sure! you wanted to delete this user?", function(result) {
							if(result) {
								$.post("<?php echo Request::$BASE_PATH.'permissionss/delete_permission/' ?>", {
				 					id: Self.attr('id'),
