				...
				<div class="main-content-inner">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue"><strong>User's Roles</strong></h3>
										
											<?php if(isset($add_message) && $add_message!= '')
												echo $add_message 
												 ;?>
										<div class="clearfix">
											<a href="<?php echo Request::$BASE_PATH.'roles/new_role';?>">
												<button class="btn btn-success"><i class="ace-icon fa fa-plus"></i> Add New User's Role</button>
											</a>
														...
														<td>
															<div class="action-buttons">
																...
																<a class="red" href="#"></a>
																	...
																	<a href="<?php echo Request::$BASE_PATH.'roles/edit_role/'.$key->id ?>">
			...
			<script>
					$(".bootbox-confirm").click(function() {
						...
						bootbox.confirm("Are you sure! you wanted to delete this user?", function(result) {
							if(result) {
								$.post("<?php echo Request::$BASE_PATH.'roles/delete_role/' ?>", {
				 					id: Self.attr('id'),
