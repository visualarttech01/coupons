        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="header smaller lighter blue"><strong>Stores</strong></h3>

                            <?php if(isset($add_message) && $add_message!= '')
                                echo $add_message
                                ;?>
                            <div class="clearfix">
                                <a href="<?php echo Request::$BASE_PATH.'stores/new_store/';?>">
                                    <button class="btn btn-success"><i class="ace-icon fa fa-plus"></i> Add Store</button>
                                </a>
